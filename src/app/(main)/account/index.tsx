...
export default function MyAccountScreen() {
    ...
    return (
        <View className='flex-1 bg-background'>
            ...
            <Pressable
                onPress={() => router.push("/(screen)/account/edit")}
                className='absolute bottom-10 mb-8 right-6 h-16 w-16 items-center justify-center rounded-full bg-primary shadow-xl shadow-primary/40 active:opacity-90 active:scale-95'
                style={{ elevation: 8 }}
            >
